# Backlog — top is next.
#
# THIS FILE IS THE PRIORITY. There is no other order anywhere in this repo.
# Reordering is one edit: move a line. The diff shows exactly what moved.
#
# Seeded 2026-08-20 from the LAST COMPUTED RANK, as a starting position and
# nothing more. That arithmetic is now deleted (DEC-202, R-068): 9 of its 17
# adjacent pairs sat within the 10% band CLAUDE.md says to escalate on, so
# this order is a leftover, not a recommendation. Reorder it freely.
#
# Parked and done items are not here. Only what could be picked up.
